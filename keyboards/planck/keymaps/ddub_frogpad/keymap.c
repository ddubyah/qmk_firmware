 ...
 * | Ent  |   Y  |   S  |   N  |   I  |   U  |      |      |   1  |   2  |  3   |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|  Ent |      |  Sym |  Num |SPC/1 |SPC/4 |      |      |   0  |      |      |
 * `-----------------------------------------------------------------------------------'
 */
...
[0] = {
  ...
  {KC_LSFT, KC_ENT,  _______, _______, MO(2),  LT(1, KC_SPC), LT(4, KC_SPC),  _______, _______, KC_0, _______, _______}
},
...
[1] = {
  ...
  {KC_CAPSLOCK, KC_X,    KC_G,     KC_K,      KC_LALT,  KC_LGUI, _______, _______, _______, _______, _______, _______},
  {_______,     _______, KC_DOT,   KC_COMMA,  _______,  _______, _______, _______, _______, _______, _______, _______}
},
...
[2]= {
  ...
  {_______, _______,   _______,     _______,  _______,  LT(3, KC_SPC),  _______, _______, _______, _______, _______, _______}
},
